...
class WG_oPhim_Footer extends WP_Widget {
    ...
    function form($instance)
    {
        ...
        <p>
            ...
            <br />
            <textarea class="widefat" rows="10" id="<?php echo $this->get_field_id('footer'); ?>" name="<?php echo $this->get_field_name('footer'); ?>"  ><?php if(isset($instance['footer']) && $instance['footer']){ echo $instance['footer'];}else{ ?>  <footer class="page-footer dark" style="background: rgb(20,20,20);">
